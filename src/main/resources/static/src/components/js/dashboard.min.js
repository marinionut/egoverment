...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"src/templates/dashboard.html"}).state("tables",{url:"/tables",templateUrl:"src/templates/tables.html"})}]);
